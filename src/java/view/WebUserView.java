...
public class WebUserView {
    ...
    public static StringDataList allUsersAPI(DbConn dbc) {
        ...
        try {
            String sql = "SELECT * FROM web_user, user_role where web_user.user_role_id = user_role.user_role_id " + 
        ...
        public static StringDataList WebUserIdAPI(DbConn dbc) {
    ...
    public static StringDataList checkUserAPI(DbConn dbc, String email, String password) {
        ...
        try {
            ...
            StringData sd = new StringData();
            sd.errorMsg = "Exception thrown in WebUserView.checkUserAPI(): " + e.getMessage();
            sdl.add(sd);
        }
        return sdl;
    }
