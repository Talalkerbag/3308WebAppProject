...
public class StringProblemList {

    public String dbError = "";
    public ArrayList<StringProblem> problemList = new ArrayList();
    ...
    public StringProblemList() {
    }

    // Adds one StringData element to the array list of StringData elements
    public void add(StringProblem stringProblem) {
        this.problemList.add(stringProblem);
    }
    ...
    public void add(ResultSet results) {
        StringProblem sd = new StringProblem(results);
        this.problemList.add(sd);
    }
}
