...
public class Search {
    ...
    public static StringData getUserById(DbConn dbc, String id) {
        ...
        try {
            String sql = "SELECT first_name, last_name, company, date_created, web_user_id, user_email, user_password, membership_fee, birthday, "
                    + "web_user.user_role_id, user_role_type "
    ...
    public static StringProblem getProblemById(DbConn dbc, String id) {
    ...
    public static StringDBSolution getSolutionById(DbConn dbc, String id) {

        //PreparedStatement stmt = null;
        //ResultSet results = null;
        StringDBSolution sd = new StringDBSolution();
        try {
            ...
            ResultSet results = stmt.executeQuery();
            if (results.next()) { // id is unique, one or zero records expected in result set
                sd = new StringDBSolution(results);
            }
            results.close();
            stmt.close();
        } catch (Exception e) {
